   ...
   <div class="card body mt-3 ml-4 mr-4 mb-3" >
          ...
          <div class="card mt-3" id="notif">
              ...
              <p class="mt-2 text-nowrap">
                <i class="fas fa-square-full ml-2 mt-2 mr-2" style="color: #114B5F;"></i> Réunion confirmée </p>
                <p class="mt-2">
                <i class="fas fa-square-full ml-2 mt-2 mr-2" style="color: #FFA500;"></i> Réunion non confirmée  </p>
                 </div> 
            </div>  
          
   <div class="card mt-3" id="notif">
              <div class="card-header">
                <h2 class="card-title text-muted text-grey mt-3 mb--3  "> Livrables non corrigés </h2>
              </div>
              <div class="card-body">
              <?php
                if (empty($livnoncorr)){?>
 <div class="alert " style="background-color:#1F7369;">
                  <button type="button" aria-hidden="true" class="close " >
                  </button>
                  <span>
                    <b style="color:#F7FFF7;" >  pas de livrables non corrigés </b> 
                  </span>
                </div>
               <?php }
               else{
               for($u=0;$u<sizeof($livnoncorr);$u++): ?>
              <div class="alert " style="background-color:#1F7369;">
                  <button type="button" aria-hidden="true" class="close " >
                  </button>
                  <span>
                <?php $pro=$projnon[$u];?>
                    <a href="{{route('projet',$pro)}}" style="color:#F7FFF7;" >   <?php echo $livnoncorr[$u];?> </a> 
                  </span>
                </div>
        <?php endfor; }?>
