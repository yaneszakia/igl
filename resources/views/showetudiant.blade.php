...
<span class="avatar avatar-sm rounded-circle">
    ...
    <div class="header  pb-8 pt-5 pt-md-8"  >
        ...
        <div class="col-xl-4 order-xl-4 mb-5 mb-xl-0">
          ...
          <div class="card card-profile shadow" style="background-color:#FFFff4;">
            ...
            <div class="card-body pt-0 pt-md-4">
                ...
                <h3>
                {{$nom}} {{$prenom}}<span class="font-weight-light elegant-color"></span>
                </h3>
              </div>
            </div>
            <form action="{{route('tofprfl')}}"   enctype="multipart/form-data"  method="post">
             {{ csrf_field() }}
             <div class="row">
           <div class="col-2"></div>
      ...
      <div class="card-body">
      <form action="/editpasswd" method="post" enctype="multipart/form-data">
      {{ csrf_field() }}
      <div class=" row form-group">
            <label  class="text-nowrap" style="color:#777474;" for="input-last-name">Mot de passe actuel </label>
            <input name="oldpasswd" type="password" id="input-last-name" class="  col-10  ml-4 form-control "  style="border-radius:30px;" value=" {{old('oldpasswd')}}" required="required">
          @if($errors->has('oldpasswd'))
              <p style="color:red;">{{ $errors->first('oldpasswd')}}</p>
          @endif
          </div>
          <div class=" row form-group">
            <label  class="text-nowrap" style="color:#777474;" for="input-last-name">Nouveau mot de passe  </label>
            <input name="password" type="password" id="input-last-name" class=" col-10  ml-4  form-control "  style="border-radius:30px;" value="" required="required">
            @if($errors->has('password'))
              <p style="color:green;">{{ $errors->first('password')}}</p>
          @endif
          </div>
          <div class=" row form-group">
            <label  class="text-nowrap" style="color:#777474;" for="input-last-name">Confirmer  mot de passe  </label>
            <input name="password_confirmation" type="password" id="input-last-name" class=" col-10  ml-4   form-control "  style="border-radius:30px;" value="" required="required">
            @if($errors->has('password_confirmation'))
              <p style="color:green;">{{ $errors->first('password_confirmation')}}</p>
          @endif
          </div>
          </div>
          <div class=" row ">
          <div class=" col-4 "></div>
          <button  class="btn btn-outline-DARK  mb-2 " >enregistrer</button> </div>
       </form>
      </div>
      </div>
      ...
      <div class="col-xl-8 order-xl-1 mb-3">
          <div class="card shadow" style="background-color:#FFFff4;">
            ...
            <div class="card-body">
              <form action="{{route('editetd')}}"  method="post" enctype="multipart/form-data" >
              {{ csrf_field() }}
              <label class="  mb-4 display-4" style=" color:#263238;">Information personnel</label> 
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input  name="nom" type="text" id="input-first-name" class="  form-control"style="border-radius:30px;"  value="{{$nom}}">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label  class="text-nowrap" style="color:#777474;" for="input-last-name">Prenom</label>
                        <input name="prenom" type="text" id="input-last-name" class=" form-control "  style="border-radius:30px;" value="{{$prenom}}">
                      </div>
                    </div>
                  </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="text-nowrap" style="color:#777474;" for="input-first-name">Spécialité</label>
                        <input name="annee" type="text" id="input-last-name" class=" form-control "  style="border-radius:30px;" value="{{$annee}}">
                         
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label  class="text-nowrap" style="color:#777474;" for="input-last-name">PIF</label>
                        <select name="pif" class="form-control " style="border-radius:30px;border-color:dark;" required="required" >
                          <option selected >{{$pif}} </option>
                          @if ($pif == "Oui")
                              <option >Non</option>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input name="email" type="email" id="input-email" class=" form-control "  style="border-radius:30px;" value="{{$email}}" disabled >
                      </div>
                    </div>
