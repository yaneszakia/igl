      ...
      <div class="container-fluid d-flex align-items-center justify-content-center h-100">
            <div class="row d-flex justify-content-center text-center">
                <div class="col-md-10">
                    ...
                    <a href="/register">
                    <button id="insc" type="button" class="btn btn-outline-white btn-lg">Inscription<i></i></button></a>
                </div>
            </div>
        </div>
    </div>
...
<main class="mt-5" style="background-color: white;">
  ...
  <div class="row d-flex justify-content-center mb-4">
      <div class="col-md-8 grey-text">
          <p>un outil web permettant aux enseignants de l’ESI d’avoir une vue sur la progression des projets qu’ils encadrent ou co-encadrent en master ou en PFE.  </p>
...
<section id="help" class="text-center">
  ...
  <div class="row">
      ...
      <div class="col-md-4 mb-1">
          ...
          <p class="grey-text">Cet outil permet aux encadrants de consulter les livrables déposer par les étudiants et les corriger   </p>
      </div>
      <div class="col-md-4 mb-1">
