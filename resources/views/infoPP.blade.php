          ...
          <div class="card mb-3"  >
               ...
               <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        @if($pv == 0)
                       <label >Ajouter pv:</label>
                       <form action="{{route('uploadpv',$idreunion)}}"   enctype="multipart/form-data"  method="post">
                       {{ csrf_field() }}
                        <input type="file" name="pv" > 
                        <button class="btn  btn-file" style="background-color: #028090;">Envoyer</button> 
                         </form>
                    </div>
                    </div>
                       @else
                    ...
                    <div class="row ">
                       ...
                       <a href="{{route('projet',$idprojet)}}" class="btn  btn-file" style="background-color:#1F7369;">
                Revenir 
            </a>
            </div>
                    </div>
